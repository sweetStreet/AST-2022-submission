...
public class GeneratedTests {
	...
	private StateEquivalenceAssertionMode assertionMode = StateEquivalenceAssertionMode.NONE;
	...
	private CrawljaxConfiguration getTestConfiguration() {
		...
		builder.setBrowserConfig(new BrowserConfiguration(BrowserType.CHROME_HEADLESS, 1, new BrowserOptions(false, -1)));
