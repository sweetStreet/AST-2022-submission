...
2. Go to folder python, run `python -m ui.main labeled_tests --project={project_name} --crawlfolder={crawl_folder_path}`
...
The results will be generated in results/heuristic
