 ...
 */
public class LabelledTestSuiteGenerator implements PostCrawlingPlugin {
	...
	public static final String TEST_SUITE_PACKAGE_NAME_LABELLED = "generated_labels";
	...
	public static final String TEST_SUITE_PATH_LABELS = TEST_SUITE_SRC_FOLDER + TEST_SUITE_PACKAGE_NAME_LABELLED.replace(".", File.separator) + File.separator;;
	public static final String CLASS_NAME = "GeneratedTests";
	public static final String FILE_NAME_TEMPLATE = "TestCaseNGL.vm";
	public static final String FILE_NAME_TEMPLATE_LABELS = "LabelledTestCaseNGL.vm";
	...
	private static final Logger LOGGER =
	        LoggerFactory.getLogger(LabelledTestSuiteGenerator.class.getName());

	public LabelledTestSuiteGenerator() {
	...
	public LabelledTestSuiteGenerator(TestConfiguration testConfiguration) {
		this();
		this.testConfiguration = testConfiguration;
	}

	public LabelledTestSuiteGenerator(HostInterface overviewHostInterface,
