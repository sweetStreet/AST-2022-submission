...
import com.crawljax.plugins.labelledTCG.fragDiff.FragDiff;
import com.crawljax.plugins.labelledTCG.fragDiff.ImageAnnotations;
import com.crawljax.plugins.labelledTCG.report.MethodResult;
import com.crawljax.plugins.labelledTCG.report.MethodResult.WarnLevel;
import com.crawljax.plugins.labelledTCG.report.ReportBuilder;
import com.crawljax.plugins.labelledTCG.report.TestRecord;
import com.crawljax.plugins.labelledTCG.report.TestRecord.TestStatusType;
import com.crawljax.plugins.labelledTCG.util.GsonUtils;
import com.crawljax.plugins.labelledTCG.util.WorkDirManager;
import com.crawljax.plugins.labelledTCG.visualdiff.ObjectDetection;
import com.crawljax.plugins.labelledTCG.visualdiff.ObjectDiff;
import com.crawljax.plugins.labelledTCG.visualdiff.pageobjects.AveragePageObjectFactory;
import com.crawljax.plugins.labelledTCG.visualdiff.pageobjects.IPageObjectFactory;
...
public class TestSuiteHelper {
	...
	public TestSuiteHelper(CrawljaxConfiguration config, String crawlPath, String url, boolean mutate)
			throws Exception {
		String jsonEventables = Paths.get(crawlPath, LabelledTestSuiteGenerator.JSON_EVENTABLES).toString();
		String jsonStates = Paths.get(crawlPath, LabelledTestSuiteGenerator.JSON_STATES).toString();
		String testRecordsFolder = Paths.get(crawlPath, LabelledTestSuiteGenerator.TEST_RESULTS).toString();
